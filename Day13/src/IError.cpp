...
std::unordered_map<Step::IError::ErrorCode, std::string> Step::IError::_error_table = {
    ...
    {Step::IError::ErrorCode::E012, "integer too large; maximum supported integer is 9223372036854775807"},
    {Step::IError::ErrorCode::E013, "float too large; maximum supported float is 1.7976931348623157e+308"},
    {Step::IError::ErrorCode::E014, "integer too small; minimum supported integer is -9223372036854775808"},
    {Step::IError::ErrorCode::E015, "float too large; minimum supported float is -1.7976931348623157e+308"},
